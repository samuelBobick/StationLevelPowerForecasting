...
from utils import aggregate_power_profiles, get_profit
from utils import get_session_results
...
def generate_session_results(sim, month, results_file_name, summary_file_name, verbose=False):
    ...
    agg_power_profile = aggregate_power_profiles(sim.test_df, power_profiles, sim.delta_t)
